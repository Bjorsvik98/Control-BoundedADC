...
def parsFunc():
    ...
    parser.add_argument("-a", "--amplitude", default=0.75, help="the amplitude of the input signal") ## anaog signal
    ...
    return N, beta, rho, kappa, amplitude, OSR, offset, size, eta2, K1, K2, DSR, bits_used, fraction_bits, outputFormat
